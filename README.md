Yasha's Steve's No-Good-Very-Bad Jekyll Theme
=====================================

Credit goes to Steve Miller's Jekyll theme.
...
`css` and `_sass` directories also functional, if a bit cluttered. Do observe new colors I created for `$harvard-crimson` and `$harvard-mortar` in `css/main.scss`.
